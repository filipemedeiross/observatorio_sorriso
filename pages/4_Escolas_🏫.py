...
labels_cpo_d_escola = {"x" : "faixa etária", "y" : "CPO-D", "color" : "escola"}
...
fig3 = px.line(alunos_escola_idade, x=[str(i) + " anos" for i in multi_indice(1)], y="cpo-d",
               ...
               title="Evolução CPO-D por escola")
fig3.update_traces(textposition="top center")
fig3.update_layout(legend_x=0)

col3.plotly_chart(fig3, use_container_width=True)

# Composição CPO-D por escola
fig4 = px.bar(alunos_escola, y=["Cariados", "Perdidos", "Obturados"], labels=labels, title="Composição CPO-D por escola")
